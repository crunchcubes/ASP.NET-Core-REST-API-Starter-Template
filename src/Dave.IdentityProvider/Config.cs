        ...
        public static IEnumerable<Client> GetClients()
        {
            return new[]
            {
                ...
                new Client
                {
                    ...
                    RedirectUris = { "https://localhost:6101/signin-oidc" },
                    FrontChannelLogoutUri = "https://localhost:6101/signout-oidc",
                    PostLogoutRedirectUris = { "https://localhost:6101/signout-callback-oidc" },
